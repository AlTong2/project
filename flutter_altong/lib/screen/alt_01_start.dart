...
import 'package:flutter_altong/controller/startController.dart';
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                MainBtn(text: loginBtnText, btnFunc: () => Get.find<StartController>().toLogin(), color: AppColors.btnColor),
                MainBtn(text: joinBtnText, btnFunc: () => Get.find<StartController>().toJoin(), color: AppColors.btnColor),
              ],
            ),
          ),
        ),
